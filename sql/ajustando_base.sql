...
from magic_steps.tbaluno t left join
magic_steps.tbalunoturma t2 on t."IdAluno" = t2."IdAluno" 
left join magic_steps.tbmotivoinativacao t3 on t2."IdMotivoInativacao" = t3."IdMotivoInativacao" ;